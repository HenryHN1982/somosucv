...
<head>
  ...
  <title>SOMOS UCV | Panel de Administración</title>
  ...
  <!-- AdminLTE Skins. Choose a skin from the css/skins
    ...
    <?= $this->Html->css('/assets/admin-lte/dist/css/skins/_all-skins.min.css') ?>
...
<!-- ./wrapper -->
  ...
  <!-- SlimScroll -->
  <?= $this->Html->script('/assets/admin-lte/bower_components/jquery-slimscroll/jquery.slimscroll.min.js') ?>
  <!-- FastClick -->
  <?= $this->Html->script('/assets/admin-lte/bower_components/fastclick/lib/fastclick.js') ?>
  <!-- iCheck -->
  <?= $this->Html->script('/assets/admin-lte/plugins/iCheck/icheck.min') ?>
  <!-- AdminLTE App -->
  <?= $this->Html->script('/assets/admin-lte/dist/js/adminlte.min.js') ?>
  <!-- AdminLTE for demo purposes -->
  <?= $this->Html->script('/assets/admin-lte/dist/js/demo.js') ?>
